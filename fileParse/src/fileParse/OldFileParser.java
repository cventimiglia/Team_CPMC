...
public class OldFileParser {
	public static void main(String[] args) throws Exception {
		...
		ArrayList<String[][]> com = createCombos(arrList, count);
	...
	public static ArrayList<String[][]> createCombos(ArrayList<Parameter> arrList, int count) {
	...
	public static ArrayList<Parameter> parseFile(String fileName) throws Exception {
